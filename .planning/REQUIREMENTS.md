...
- [x] **PERF-01**: Search supports pagination with offset/limit parameters (no 100-result hard cap)
...
- [x] **QUAL-05**: Error boundaries (error.tsx) added at app root and critical route segments
